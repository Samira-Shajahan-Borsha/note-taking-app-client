...
import { columns } from "./AllNotesColumns";
import type { INote, INoteMeta } from "@/types/note.interface";

interface AllNotesDataTableProps {
    notes: INote[];
    meta: INoteMeta;
    page: number;
    limit: number;
...
const AllNotesDataTable = ({ notes, meta, page, limit }: AllNotesDataTableProps) => {
...
export default AllNotesDataTable;